...
Sub EndAcquisition
    Dim url : url = "http://127.0.0.1:5500/endAcquisition"
    Dim data : data = "{""path"":""" & path & """}"
    Dim http
...
Function EdgesAcquisition(ByVal operator)
    ...
    Dim pathCol: pathCol = "C:\Users\RAMAN\Desktop\GiorgioChelliScripts\acquisition\colonne\acquisizione5\"
    Dim filename
...
Sub Serialization(ByVal result, ByRef find, ByRef row)
