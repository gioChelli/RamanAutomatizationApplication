...
Const AXISYx10 = 410 'dimensione standard della colonna con scope x5
Const AXISXx10 = 440 'dimensione standard della riga con scope x5
Const MOTOR_VALUE = 0
...
Sub main
    ...
    If ErrorConnection = True Then
        Exit Sub
    End If
    LabSpec.MoveMotor "X", STARTROWGLASS, positionName, MOTOR_VALUE
    LabSpec.MoveMotor "Y", startY, positionName, MOTOR_VALUE
    
    LabSpec.MoveMotor "X", STARTROWGLASS, positionName, MOTOR_ORIGIN
    LabSpec.MoveMotor "Y", startY, positionName, MOTOR_ORIGIN
